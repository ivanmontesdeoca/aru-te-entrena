...
export interface RutinaSesionRepository extends EntityRepository<RutinaSesion> { findByAlumno(alumnoId: UUID): Promise<RutinaSesion[]>; markCompleted(id: UUID, completedAt: string): Promise<void>; removeCreated(id: UUID): Promise<void>; }
